# openapi-projector AI Handoff Guide

This directory is the OpenAPI workspace generated by `openapi-projector`.

Read this file before modifying generated API code. The goal is not to commit generated candidate files directly. The goal is to inspect the generated candidates, adapt the project rules to the current frontend project, and then copy only the useful DTO/API code into the real application source tree.
...
## 2. AI Task Prompt Example

Users can paste this prompt into an AI coding agent after running `init`:
...
## 3. Recommended Step-by-Step Flow
...
## 4. Repeated Runs: Review OpenAPI Changes
...
## 5. After `rules`: Adapt Project Rules
...
## 6. How to Fill `project-rules.jsonc`
...
## 7. After `project`: Review Candidate Output
...
## 10. Files You Usually Should Not Edit Manually
