...
Swagger/OpenAPI 변경 비교와 DTO/API 후보 생성을 실제 앱 코드와 분리해 둡니다.
...
두 번째 실행부터는 `openapi/project/summary.md`와 `openapi/project/src/openapi-generated/` 아래 DTO/API 후보가 생성됩니다.
