...
OpenAPI JSON URL을 아직 모르면 먼저 작업 공간만 만들고, 이후 `openapi/config/project.jsonc`의 `sourceUrl`을 수정하세요.
...
- `Contract Changed` 항목에는 request/response/schema/parameter의 필드 단위 변경 내용이 표시됩니다.
